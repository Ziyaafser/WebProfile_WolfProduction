...
export const mission = [
  ...
  "Provide client-focused solutions emphasizing accuracy, safety, and long-term value",
  "Build lasting relationships through integrity, responsiveness, and measurable results"
];
...
export const services = {
  tabs: [
    ...
    },
    {
      id: "supplies",
      label: "Supplies & Data",
      description: "Data-driven project support from collection and compliance through modelling, analysis, and technical drafting.",
      items: [
...
export const technologies = [
  {
    title: "LiDAR Inspection & 3D Structure Mapping",
